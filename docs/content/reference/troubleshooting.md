...
Most of these come down to network reality or how chotot serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

chotot rate-limits like any public site. chotot already paces
...
Where a surface is gated, chotot reads a cookie or token you supply
...
`chotot`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what chotot actually did
